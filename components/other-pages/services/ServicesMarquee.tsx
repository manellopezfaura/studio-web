...
export function ServicesMarquee() {
  const t = useTranslations("ServicesPage.Marquee");
  ...
  return (
    <div className="mxd-section overflow-hidden padding-pre-title">
      <div className="svc-marquee">
        ...
        >
          {items.map((item, i) => (
            <span key={i} className="svc-marquee__item">
              <span className="svc-marquee__text">{item}</span>
              <span className="svc-marquee__separator" aria-hidden="true">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
