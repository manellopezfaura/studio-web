        ...
        <div className="mxd-hero-00__wrap">
                ...
                >
                  ...
                  {Array.from({ length: 5 }).map((_, index) => (
                    ...
                    >
                      ...
                      {/* <Image class="inject-me" src="/img/icons/20x20-star.svg" alt="Divider Icon"> */}
                    </div>
                  ))}
                </VelocityMarquee>
              </div>
              ...
              <h1 className="hero-00-title">
                ...
                <span className="hero-00-title__row loading__item">
                  <em className="hero-00-title__item title-item-image">
                    ...
                    {/* <img class="inject-me" src="/img/icons/20x20-star.svg" alt="Divider Icon"> */}
                  </em>
          ...
          <div className="mxd-hero-00__bottom">
            <div className="hero-00-manifest loading__fade">
              ...
              >
                Elevate your digital presence with 107 Studio - dynamic and stylish
                website designed for creative agencies and personal brands.
              </RevealText>
            </div>
          </div>
        </div>
